...
<head>
    ...
    <meta name="keywords" content="équipe de professionnels">
    <!-- CSS -->
...
<body>
    ...
    <main>
        <section id="banniere">
            <div class="mere">
                <img src="./assets/images/banniere-apropos.jpg" alt="Notre équipe">
                <div class="enfant">
        ...
        <div class=texte>
            <p>Quels que soient votre état d’esprit et le projet immobilier qui vous amènent, nos professionnels de
                ...
                avons collecté une multitude de datas qui seront une véritable aide à la décision en vue de votre
                prochaine
